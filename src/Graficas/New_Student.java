 ...
 * @author Aprendiz
 */
public class New_Student extends javax.swing.JPanel {

    /**
     * Creates new form New_Estudiante
     */
    public New_Student() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(1700, 650));
        ...
        Txt_nameStudent.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Txt_LastNameStudent.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Txt_Day_Born.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Txt_DocumentStudent.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Input_panelLayout.setHorizontalGroup(
            ...
            .addGroup(Input_panelLayout.createSequentialGroup()
                .addGap(500, 500, 500)
                .addComponent(Lbl_Student, javax.swing.GroupLayout.PREFERRED_SIZE, 500, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(500, 500, 500))
            .addGroup(Input_panelLayout.createSequentialGroup()
                .addGap(148, 148, 148)
        ...
        add(Input_panel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1650, 1280));
    ...
    private void Btn_CreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn_CreateActionPerformed
        ...
        int grado = (int) Box_grade.getSelectedItem();
        String seccion = Box_section.getSelectedItem().toString();
        String direccion = Txt_Direction.getText();
        int telefono = Integer.parseInt(Txt_telephone.getText());
        ...
        try{
            ...
            PreparedStatement ps = con.prepareStatement("INSERT INTO estudiantes (Nombres, Apellidos, Fechanacimiento, Grado, Seccion ,Direccion, Telefono, Email, Contraseña) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
